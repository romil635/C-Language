...
void foodorder::menu()
{
    cout<<"\n________BROWN DOSA_______";             cout<<"\t\t____BROWN DOSA______";            cout<<"\t\t==========================";         cout<<"\t\t===========================";        
    cout<<"\n----------------------------";             cout<<"\t\t-----------------------";            cout<<"\t\t_TODAY'S SPECIAL DISCOUNT_";         cout<<"\t\t_____OUR  SPECIALITY_____";
    cout<<"\n-------SOUTH INDIAN---------";             cout<<"\t\t------COLD DRINK-------";            cout<<"\t\t--------------------------";         cout<<"\t\t---------------------------";
    cout<<"\nNO.       MENU         PRICE";             cout<<"\t\tNO.      MENU     PRICE";            cout<<"\t\t________30% OFF_________";         cout<<"\t\t NO GST FOR....";
